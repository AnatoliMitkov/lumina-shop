  ...
  return (
    <div className="pt-32 md:pt-40 pb-24 md:pb-28 px-6 md:px-12 max-w-[1200px] mx-auto">
      <section className="border border-[#1C1C1C]/10 bg-white/58 rounded-sm p-8 md:p-10 flex flex-col gap-8">
        <div>
          <p className="text-[10px] uppercase tracking-[0.3em] text-[#1C1C1C]/45 mb-4">Payment Not Completed</p>
        ...
        <p className="max-w-2xl text-sm md:text-base leading-relaxed text-[#1C1C1C]/62">
          The secure checkout was not completed. Your current selection stays in place, so you can return to checkout, adjust the order, or send it through atelier review instead.
        </p>

        <div className="flex flex-col sm:flex-row gap-3">
          <a href="/checkout" className="hover-target transition-link inline-flex items-center justify-center px-8 py-4 bg-[#1C1C1C] text-[#EFECE8] uppercase tracking-[0.2em] text-xs font-medium hover:bg-black transition-colors">Return To Checkout</a>
