const SUPABASE_URL =
  import.meta.env.VITE_SUPABASE_URL ?? 'https://hvkgcmgqelczdnvhxtrj.supabase.co';
...
const PRODUCTS_ENDPOINT = `${SUPABASE_URL}/rest/v1/products?select=id,name,slug,price,subtitle,collection,image_main,image_detail,gallery,featured,sort_order,status,created_at&status=eq.active&order=featured.desc,sort_order.asc.nullslast,created_at.asc&limit=12`;
